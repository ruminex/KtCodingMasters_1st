중학생이 된 수진은 수학시간에 어떤 음이아닌 정수 N을 b진수로 표현하는 방법을 배웠습니다.
...
28을 16으로 나누면 몫이 1이고 나머지는 12, 즉 C입니다.
...
수진은 N을 8진수와 16진수로 표현해봤는데 본인이 맞게 표현했는지 궁금해졌습니다.

수진을 위해 10진수 N을 입력 받아 그 수의 8진수와 16진수 표현을 모두 출력하는 프로그램을 작성하세요.